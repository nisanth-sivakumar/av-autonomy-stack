...
struct CarlaTrafficLightStatusList_
{
  ...
  using _traffic_lights_type =
    std::vector<carla_msgs::msg::CarlaTrafficLightStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_msgs::msg::CarlaTrafficLightStatus_<ContainerAllocator>>>;
  _traffic_lights_type traffic_lights;

  // setters for named parameter idiom
  Type & set__traffic_lights(
    const std::vector<carla_msgs::msg::CarlaTrafficLightStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_msgs::msg::CarlaTrafficLightStatus_<ContainerAllocator>>> & _arg)
  {
