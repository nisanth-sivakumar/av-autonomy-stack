...
struct CarlaActorList_
{
  ...
  using _actors_type =
    std::vector<carla_msgs::msg::CarlaActorInfo_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_msgs::msg::CarlaActorInfo_<ContainerAllocator>>>;
  _actors_type actors;

  // setters for named parameter idiom
  Type & set__actors(
    const std::vector<carla_msgs::msg::CarlaActorInfo_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_msgs::msg::CarlaActorInfo_<ContainerAllocator>>> & _arg)
  {
    this->actors = _arg;
    return *this;
  }
