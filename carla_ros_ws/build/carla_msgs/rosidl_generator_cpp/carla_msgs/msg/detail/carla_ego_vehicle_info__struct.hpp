...
struct CarlaEgoVehicleInfo_
{
  ...
  using _wheels_type =
    std::vector<carla_msgs::msg::CarlaEgoVehicleInfoWheel_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_msgs::msg::CarlaEgoVehicleInfoWheel_<ContainerAllocator>>>;
  _wheels_type wheels;
  using _max_rpm_type =
    float;
  ...
  Type & set__wheels(
    const std::vector<carla_msgs::msg::CarlaEgoVehicleInfoWheel_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_msgs::msg::CarlaEgoVehicleInfoWheel_<ContainerAllocator>>> & _arg)
  {
    this->wheels = _arg;
    return *this;
  }
