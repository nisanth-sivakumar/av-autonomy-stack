  ...
  // Field name: traffic_lights
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, carla_msgs, msg, CarlaTrafficLightStatus
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _CarlaTrafficLightStatusList__ros_msg_type * ros_message = static_cast<_CarlaTrafficLightStatusList__ros_msg_type *>(untyped_ros_message);
  // Field name: traffic_lights
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
