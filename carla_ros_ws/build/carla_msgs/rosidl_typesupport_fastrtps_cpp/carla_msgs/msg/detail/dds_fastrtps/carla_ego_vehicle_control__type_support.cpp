...
#include "carla_msgs/msg/detail/carla_ego_vehicle_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carla_msgs::msg::CarlaEgoVehicleControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs::msg::CarlaEgoVehicleControl & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs::msg::CarlaEgoVehicleControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const carla_msgs::msg::CarlaEgoVehicleControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carla_msgs::msg::CarlaEgoVehicleControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CarlaEgoVehicleControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carla_msgs::msg::CarlaEgoVehicleControl *>(
...
static size_t _CarlaEgoVehicleControl__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_CarlaEgoVehicleControl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CarlaEgoVehicleControl__callbacks = {
  "carla_msgs::msg",
...
static rosidl_message_type_support_t _CarlaEgoVehicleControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CarlaEgoVehicleControl__callbacks,
...
{
  return &carla_msgs::msg::typesupport_fastrtps_cpp::_CarlaEgoVehicleControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_msgs, msg, CarlaEgoVehicleControl)() {
  return &carla_msgs::msg::typesupport_fastrtps_cpp::_CarlaEgoVehicleControl__handle;
}
