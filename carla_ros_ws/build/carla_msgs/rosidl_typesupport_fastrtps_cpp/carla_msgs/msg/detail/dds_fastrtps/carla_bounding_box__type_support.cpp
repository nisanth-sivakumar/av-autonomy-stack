  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs::msg::CarlaBoundingBox;
    is_plain =
      (
...
static size_t _CarlaBoundingBox__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_CarlaBoundingBox(full_bounded, is_plain, 0);
