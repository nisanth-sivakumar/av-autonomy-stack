  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_msgs::msg::CarlaWorldInfo;
    is_plain =
      (
      offsetof(DataType, opendrive) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CarlaWorldInfo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_CarlaWorldInfo(full_bounded, is_plain, 0);
