...
struct CarlaScenarioList_
{
  ...
  using _scenarios_type =
    std::vector<carla_ros_scenario_runner_types::msg::CarlaScenario_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_ros_scenario_runner_types::msg::CarlaScenario_<ContainerAllocator>>>;
  _scenarios_type scenarios;

  // setters for named parameter idiom
  Type & set__scenarios(
    const std::vector<carla_ros_scenario_runner_types::msg::CarlaScenario_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<carla_ros_scenario_runner_types::msg::CarlaScenario_<ContainerAllocator>>> & _arg)
  {
    this->scenarios = _arg;
    return *this;
  }
