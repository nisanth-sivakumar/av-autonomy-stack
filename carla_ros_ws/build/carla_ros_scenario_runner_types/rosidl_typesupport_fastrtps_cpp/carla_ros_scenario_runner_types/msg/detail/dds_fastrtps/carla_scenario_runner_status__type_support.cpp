  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_ros_scenario_runner_types::msg::CarlaScenarioRunnerStatus;
    is_plain =
      (
...
static size_t _CarlaScenarioRunnerStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CarlaScenarioRunnerStatus(full_bounded, is_plain, 0);
